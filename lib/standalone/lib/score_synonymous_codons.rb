class ScoreSynonymousCodons
    ...
    def initialize(strategy, ese_strategy, score_eses_at_all_sites, cpg_enrichment_score, tpa_enrichment_score, synonymous_sites, ese_motifs)
        @strategy_scorer = StrategyScores.new(strategy, cpg_enrichment_score, tpa_enrichment_score)
    ...
    def score_by_strategy(pos, syn_codons)
        ...
        @strategy_scorer.normalised_scores(syn_codons, orig_codon, next_codon_synonyms, pos, is_near_intron, distance_to_intron)
    end
