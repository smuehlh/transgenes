class Gene
    ...
    def tweak_exonic_sequence(strategy, ese_strategy, score_eses_at_all_sites, cpg_enrichment_score)
        scorer = ScoreSynonymousCodons.new(strategy, ese_strategy, score_eses_at_all_sites, cpg_enrichment_score,
